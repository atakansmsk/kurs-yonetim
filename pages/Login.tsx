  ...
  return (
    <div className="min-h-screen w-full bg-[#F8FAFC] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl shadow-indigo-200/50 border border-white relative animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button 
                type="submit" 
                disabled={loading}
                className="w-full py-4 mt-2 bg-slate-900 text-white rounded-2xl font-bold text-base shadow-xl shadow-slate-300 hover:shadow-2xl hover:bg-slate-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-wait"
            >
                {loading ? (
      ...
      <div className="mt-6 text-center opacity-40">
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Secure Cloud Sync Ready</p>
      </div>
    </div>
  );
};