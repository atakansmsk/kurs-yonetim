...
export const ParentView: React.FC<ParentViewProps> = ({ teacherId, studentId }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-800 selection:bg-indigo-100 pb-32">
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative bg-gradient-to-b from-white to-[#F8FAFC] pb-6 pt-12 px-6 rounded-b-[2.5rem] shadow-sm mb-6 border-b border-slate-100">
      ...
      <div className="max-w-md mx-auto px-5 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
            ...
            {student.debtLessonCount > 0 && (
                <div className="col-span-2 bg-indigo-50 p-3 rounded-2xl border border-indigo-100 flex items-center justify-between px-4">
                    <div className="flex items-center gap-2">
        ...
        <div>
            <div className="flex items-center justify-between mb-4 px-1">
                ...
                <span className="text-[10px] font-bold text-slate-300 bg-slate-50 px-2 py-1 rounded-lg">Filtreli</span>
            </div>
                        ...
                        {currentPeriodHistory.map((tx, idx) => {
                            ...
                            return (
                                <div key={tx.id} className="relative group">
                                    <div className={`absolute -left-[16px] top-1.5 w-3 h-3 rounded-full border-2 border-white shadow-sm z-10 ${dotColor}`}></div>
        ...
        {/* --- HOMEWORK & RESOURCES (With Image Preview) --- */}
        {(student.resources || []).length > 0 && (
            <div>
                <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4 px-1 mt-8">ÖDEVLER & MATERYALLER</h3>
                                ...
                                <div className="aspect-video w-full bg-slate-100 relative overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-4">
                                        <div className="flex items-center gap-2 text-white/90 mb-1">
                                            <Image size={14} />
                                            <span className="text-[10px] font-bold uppercase tracking-wider">RESİM / NOTA</span>
                                        </div>
