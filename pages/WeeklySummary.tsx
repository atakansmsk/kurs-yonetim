...
import { Maximize2, X, Star, RefreshCcw, CalendarCheck, Clock, Coffee } from 'lucide-react';
                            ...
                            <div className="flex-1 flex flex-col w-full relative">
                                {isEmpty ? (
                                    <div className="flex-1 flex flex-col items-center justify-center opacity-20">
                                        <Coffee size={isScreenshotMode ? 12 : 24} className="text-slate-400 mb-1" />
                                        <span className={`font-bold text-slate-400 ${isScreenshotMode ? 'text-[6px]' : 'text-[9px]'}`}>Ders Yok</span>
                                    </div>
                                ) : (
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div 
                                                        ...
                                                        className={`w-full h-full rounded-lg shadow-sm flex flex-col justify-center px-1 relative overflow-hidden transition-all hover:scale-[1.05] hover:z-10 cursor-pointer ${
                                                            isMakeup 
